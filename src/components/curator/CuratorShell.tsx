...
import { LayoutDashboard, Users, Users2, MessageCircle, LogOut, ArrowLeft, Bell, UserCircle, Calendar } from 'lucide-react'
...
const NAV: NavItem[] = [
  ...
  { href: '/curator/calendar', label: 'Календарь', icon: Calendar },
