      ...
      <div className="container mx-auto px-6" style={{ paddingTop: '4.5rem', paddingBottom: '4rem' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.75rem', color: '#3E4E3C', maxWidth: '50rem', lineHeight: 1.7 }}>
            Персональные данные обрабатываются в соответствии с Федеральным законом № 152-ФЗ
            «О персональных данных». Используя сайт, вы соглашаетесь с{' '}
            <Link href="/legal/privacy" style={{ color: '#5A7A58', textDecoration: 'underline', textUnderlineOffset: '2px' }}>
              политикой конфиденциальности
            </Link>
            {' '}и обработкой ваших данных.
          </p>
        </div>
      </div>
    </footer>
