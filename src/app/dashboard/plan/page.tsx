...
const TIER_INFO: Record<string, { label: string; color: string; features: string[] }> = {
  ...
  base: {
    label: 'Базовый',
    color: '#4E7B5E',
    features: ['4 групповые встречи', 'Чат с психологом', 'Задания и дневник', 'Записи встреч', 'Материалы программы'],
  },
  plus: {
    label: 'Плюс',
    color: '#4E7B5E',
      ...
      {tier !== 'personal' && (
        <div>
          ...
          <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', textAlign: 'center' }}>
            ...
            <a href="mailto:snovassoboi@yandex.com" style={{ color: 'var(--primary)', textDecoration: 'none' }}>
