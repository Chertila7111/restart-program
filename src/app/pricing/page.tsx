        ...
        <div className="container mx-auto px-6" style={{ maxWidth: '64rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: '1rem' }}>
            {[
              ...
              { q: 'Возможен ли возврат?', a: 'Да. Вводную встречу можно отменить до начала — возврат полный. По групповой программе и индивидуальным пакетам возврат возможен за неоказанные встречи. Уже проведённые встречи не возвращаются. Условия в публичной оферте.' },
