        ...
        <div className="container mx-auto px-6" style={{ maxWidth: '64rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: '1rem' }}>
            {[
              ...
              { q: 'Возможен ли возврат?', a: 'Да. Если после первой встречи формат не подошёл — вернём полную стоимость в течение 7 дней. Условия описаны в публичной оферте.' },
              { q: 'Цена включает все материалы?', a: 'Да. В цену входят все встречи, доступ к чату с куратором, задания и записи встреч.' },
            ].map((faq) => (
              <div key={faq.q} style={{
                background: 'white',
