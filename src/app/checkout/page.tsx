...
const segmentCopy: Record<string, { badge: string; descOverrides: Record<string, string> }> = {
  slozhnye: {
    ...
    descOverrides: {
      ...
      'clarity-start': '3 встречи один на один с психологом — разобраться в ситуации без давления принять решение прямо сейчас.',
      'clarity-deep': '5 встреч один на один — глубже: паттерны, самооценка, границы и ясность о том, чего вы хотите.',
    },
  },
  rasstalis: {
    badge: '',
