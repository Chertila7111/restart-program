...
const faqs = [
  ...
  { q: 'Есть ли возврат средств?', a: 'Да. Вводную встречу можно отменить до начала — возврат полный. По программе и индивидуальным пакетам возврат возможен за неоказанные встречи. Уже проведённые встречи не возвращаются.' },
  ...
  { q: 'Что если я пойму, что группа мне не подходит?', a: 'Мы честно скажем об этом ещё на вводной встрече, если заметим, что формат не ваш. По программе возможен возврат за неоказанные встречи. Вводная встреча — разовая услуга, возврат возможен только до её начала.' },
