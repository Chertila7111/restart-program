...
export const metadata: Metadata = {
  ...
  description: '4-недельная программа с психологом и группой: для тех, кто переживает расставание или устал от сложных отношений. Встречи, задания, дневник и личный план.',
}
...
const programWeeks = [
  ...
  {
    week: 'Неделя 2',
    title: 'Границы и честность с собой',
    meeting: 'Работа с тем, что держит: вина, привязанность, страх, надежда. Как распознать импульсивные действия и не действовать из них.',
    task: 'Практика паузы перед импульсивными действиями. Письмо, которое не отправляют — сказать себе всё, что накопилось.',
    result: 'Откаты стали реже. Появился понятный план действий в острый момент.',
  },
  {
    week: 'Неделя 3',
        ...
        <div className="container mx-auto px-6">
          <div style={{ maxWidth: '52rem', marginBottom: '3rem' }}>
            ...
            <p style={{ fontSize: '1.05rem', color: 'var(--text-muted)', lineHeight: 1.8, marginBottom: '2rem' }}>
              4-недельная онлайн-программа с психологом, закрытым чатом и структурированными практиками. Для тех, кто переживает расставание или развод — и для тех, кто устал от сложных отношений и хочет вернуть опору на себя. Не «просто поговорить» — конкретный путь из хаоса к ясности.
            </p>
