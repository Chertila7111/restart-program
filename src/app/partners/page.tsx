      ...
      <section style={{ background: 'var(--bg-soft)', padding: '4rem 0' }}>
        <div className="container mx-auto px-6" style={{ maxWidth: '52rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', lineHeight: 1.8, fontSize: '0.95rem' }}>
            «Снова с собой» — онлайн-программа восстановления после расставания и развода. 4 недели, небольшая группа (до 8 человек), практикующий психолог. Работаем с тревогой, пустотой, желанием вернуться, самооценкой и планированием следующего шага. Программа построена на принципах групповой психотерапии — не коучинг и не мотивационный курс.
          </p>
