        ...
        <div className="container mx-auto px-6" style={{ maxWidth: '52rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', marginBottom: '2.5rem' }}>
            {[
              ...
              { num: '2', title: '4 недели программы', desc: 'Встречи, задания, чат с куратором. Психолог ведёт группу: безопасная динамика, структура, конкретные шаги.', price: 'от 6 490 ₽' },
